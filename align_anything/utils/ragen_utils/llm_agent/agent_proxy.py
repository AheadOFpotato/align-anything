...
from ..verl_compat import DataProto, pad_dataproto_to_divisor, unpad_dataproto
# import time
...
class LLMAgentProxy:
	...
	def generate_sequences(self, lm_inputs: DataProto):
		...
		# DISABLE RAY WORKER GROUP FOR NOW:
	...
	def rollout(self, dataproto: DataProto, val=False):
		...
		# t = self.tokenizer.batch_decode(rollouts.batch['input_ids'], skip_special_tokens=False) # see all the trajectories
		return rollouts
